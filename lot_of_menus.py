...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description=" A famous duck dish from Beijing[1] that has"
                                 " been prepared since the imperial era."
                                 " The meat is prized for"
                                 " its thin, crisp skin, with authentic"
                                 " versions of the"
                                 " dish serving mostly the skin"
                                 " and little meat,"
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                     description="A Chinese noodle soup made of stewed"
                                 " or red braised beef, beef broth,"
...
menuItem6 = MenuItem(user_id=1, name="Ramen",
                     description="a Japanese noodle soup dish. It consists"
                                 " of Chinese-style wheat noodles served in"
                                 " a meat- or (occasionally)"
                                 " fish-based broth,"
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     description="a Vietnamese noodle soup consisting of"
                                 " broth, linguine-shaped rice noodles"
...
menuItem3 = MenuItem(user_id=1, name="Gyoza",
                     description="light seasoning of Japanese gyoza with salt"
                                 " and soy sauce, and in"
                                 " a thin gyoza wrapper",
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     description="Golden fried cauliflower florets in a midly"
                                 ...
                                 " cilantro, celery, chilies,ginger &"
                                 " green onions",
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     description="Chicken marinated in yoghurt and seasoned"
                                 " with a spicy mix(chilli,"
                                 " tamarind among others) and slow cooked"
                                 " in a cylindrical clay or metal oven which"
